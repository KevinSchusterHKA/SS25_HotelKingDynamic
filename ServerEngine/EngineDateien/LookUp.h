...
const MapReturnObj _chestCards[] = {
    ...
    MapReturnObj(-1, TypeTax, -3, 40, 0, "Straßenreparaturkosten. Zahle 40" + string(1, _symbolchars[Coin]) + " pro Haus und 120" + string(1, _symbolchars[Coin]) + " pro Hotel"),
...
const MapReturnObj _chanceCards[] = {
    ...
    MapReturnObj(-1, TypeTax, -1, 100, 0, "Zahle 100" + string(1, _symbolchars[Coin]) + " für Renovierungsarbeiten"),
